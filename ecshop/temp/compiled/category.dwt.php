...
?>
      ...
      <?php endif; ?>
      <?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_98684400_1529025873');if (count($_from)):
    foreach ($_from AS $this->_var['filter_attr_0_98684400_1529025873']):
?>
      <div class="screeBox"> <strong><?php echo htmlspecialchars($this->_var['filter_attr_0_98684400_1529025873']['filter_attr_name']); ?> :</strong>
        <?php $_from = $this->_var['filter_attr_0_98684400_1529025873']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'attr');if (count($_from)):
